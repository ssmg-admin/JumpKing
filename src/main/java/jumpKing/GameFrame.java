...
class GameFrame extends JPanel {
    ...
    public void updateGame(){
        /*
         * Typical "frame update" structure in simple 2D games:
         * 1) Read input: ask KeyInput/MouseInput for current states (pressed/released).
         * 2) Apply movement/physics: change entity positions based on input and gravity.
         * 3) Resolve collisions: stop entities from overlapping platforms/walls.
         * 4) Update game rules: score, death, level transitions, etc.
         *
         * This project currently has placeholder entities; you will implement the
